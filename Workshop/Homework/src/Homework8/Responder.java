...
public class Responder
{
    ...
    private void fillResponseMap()
    {
        ...
        responseMap.put("java", "Java is a programming language.\nYou might have seen its name in an error message, because we can't seem to get rid of those NullPointerExceptions.");

        responseMap.put("feature", "Now you've got it, it's not a bug, its a feature.");

        responseMap.put("electron", "This is not an electron app, we promise.\nIt's written using dotnet, which is probably way worse.");
