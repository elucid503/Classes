...
public class BinarySearch {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(values[SIZE/2] + " is in array: " + binarySearchIterative(values[SIZE/2], 0, SIZE - 1));
    System.out.println(values[SIZE - 1] + " is in array: " + binarySearchIterative(values[SIZE - 1], 0, SIZE - 1));
    ...
    */
    ...
    System.out.println(values[SIZE / 2] + " is in array: " + binarySearchRecursive(values[SIZE / 2], 0, SIZE - 1));
    System.out.println(values[SIZE - 1] + " is in array: " + binarySearchRecursive(values[SIZE - 1], 0, SIZE - 1));
